...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Amacımız Menüsü</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
    ...
    <form class="container" method="POST">
        <table id="customers" class="bizkimiz" method="post">
            ...
            <tr>
                ...
                $id = $_GET['id'];
                $sec = "Select * From amacimiz where id=$id ";
                $sonuc = $baglan->query($sec);

                if ($sonuc->num_rows > 0) {
                    while ($cek = $sonuc->fetch_assoc()) {
                        echo '
                <td><input type="text" name="amacimizbaslik" value=' . $cek['hbaslık'] . '></td>
                <td width="800"><input type="text" name="amacimizparagraf" value=' . $cek['paragraf'] . '></td>
                
            ';
                    }
                } ?>
                <td><button type="submit" class="btn btn-info">Gönder</button></td>
            </tr>
        </table>
    </form>
    ...
    <form method="post">
        ...
        <tr>
            <td>" . $cek['hbaslık'] . "</td>
            <td>" . $cek['paragraf'] . "</td>
            <td><a href='ama-sil.php?id=" . $cek['id'] . "' class='btn btn-danger'>Sil</a></td>
      ";
                }
            }
            ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="ama_yukle.php" method="POST" enctype="multipart/form-data">
            ...
            while ($cek = $sonuc->fetch_assoc()) {
                echo '<table id="customers" class="container">
                    <tr>            
                        ...
                        <td width="100"><a href="ama_resim_sil.php?id=' . $cek['id'] . '" class="btn btn-danger">Sil</a>
                        </td>
                    </tr>';
            }
        } else {
    ...
    if ($_GET) {
        if ($_POST) {
            if (isset($_POST["amacimizbaslik"], $_POST["amacimizparagraf"])) {
                ...
                $id= $_GET['id'];
                $ekle = "UPDATE amacimiz SET `hbaslık`= '" . $hbaslık . "',`paragraf`='" . $paragraf . "' where id =$id";

                if ($baglan->query($ekle) === true) {
                    echo "<script>alert('Mesajınız başarı ile gönderilmiştir')</script>";
                    header("location:duzenle_adminamac.php");
                } else {
