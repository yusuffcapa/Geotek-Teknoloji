...
<body class="hold-transition sidebar-mini">
    ...
    <form class="container" method="POST" action="kaydet_amacimiz.php">
        <table id="customers" class="bizkimiz" method="post">
            ...
            <tr>
                <td><input type="text" placeholder="Başlık" name="amacimizbaslik"></td>
                <td width="800"><input type="text" placeholder="Paragraf" name="amacimizparagraf"></td>
    ...
    <form method="post">
        ...
        <tr>
            <td>" . $cek['hbaslık'] . "</td>
            <td>" . $cek['paragraf'] . "</td>
            <td><a href='duzenle_adminamac.php?id=" . $cek['id'] . "' class='btn btn-warning' name='duzenle'>Düzenle</a></td>
