...
<body>
        ...
        <div class="gallery">
            ...
            if ($sonuc->num_rows > 0) {
                while ($cek = $sonuc->fetch_assoc()) {
                    echo '<a href="' . $cek["link"] . '" class="gallery-item" target="_blank">
          <img src="' . $cek["resim"] . '" alt="">' . $cek["baslik"] . '</a>';
                }
            }
            ?>
        </div>
    ...
    <footer>
        <div class="conatiner-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        © GEOTEK Teknoloji, Tüm hakları saklıdır.<br /><a href="https://www.instagram.com/ysfcpaa/">Yusuf ÇAPA</a>
    ...
    <script src="assets/js/dosya.js"></script>
